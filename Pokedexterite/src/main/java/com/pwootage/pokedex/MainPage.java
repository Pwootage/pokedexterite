...
public class MainPage extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
		...
		switch (position) {
			case 0:
				fragment = SuperSearchFragment.newInstance();
				break;
			default:
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                mTitle = getString(R.string.title_pokedex);
                break;
            case 2:
                mTitle = getString(R.string.title_attackdex);
                break;
            case 3:
                mTitle = getString(R.string.title_movedex);
                break;
			case 4:
				mTitle = getString(R.string.title_itemdex);
				break;
			case 5:
